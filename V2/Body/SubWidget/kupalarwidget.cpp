#include "kupalarwidget.h"

Kupa::KupalarWidget::KupalarWidget()
    :WContainerWidget()
{
...

    {
        ...
        auto text = container->addWidget(cpp14::make_unique<WText>("Kupalarımız"));
...

    {
        ...
        for( int i = 0 ; i < 12 ; i++ )
        {
            ...
            imgContainer->setAttributeValue(Style::style,Style::background::url("img/kupa.jpg")+
            ...
            {
                auto text = textLayout->addWidget(cpp14::make_unique<WText>("Bal Ligi Birincilik Kupası"),0,AlignmentFlag::Middle);
